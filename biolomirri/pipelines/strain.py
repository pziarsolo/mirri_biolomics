...
from biolomirri.remote.biolomics_client import BiolomicsMirriClient, BIBLIOGRAPHY_WS, SEQUENCE_WS, STRAIN_WS
from biolomirri.serializers.sequence import GenomicSequenceBiolomics
